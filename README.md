...
The extension is deployed to chrome extension store and is waiting for review. Will add a link once it's deployed, until then, follow the guide to enable it locally.
